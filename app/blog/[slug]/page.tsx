...
const PostPage: NextPage = () => {
    ...
    useEffect(() => {
        const fetchPost = async () => {
            ...
            try {
                ...
                const lang = window.location.href.split("/")[4].split("?lang=")[1] == "de"
                    ? foundPost.de
                    : foundPost.en;
    ...
    return (
        <>
            ...
            {loading ? (
                <div
                    className="w-full h-screen flex items-center justify-center text-gray-600 dark:text-gray-300 text-xl">
                    Loading post...
                </div>
            ) : post ? (
                <motion.section
                ...
                >
                    ...
                    <div className="relative h-64 sm:h-96 w-full">
                        ...
                        />
                        <div
                            className="absolute inset-0 bg-gradient-to-b from-black/30 to-black/80 flex flex-col justify-end p-6 md:p-12">
