      ...
      <div className=" bg-zinc-900 rounded-2xl shadow-xl p-6 max-w-5xl w-full flex gap-6 relative">
                ...
                <CarouselItem key={index} className="w-full">
                  <Card className="w-full h-96 relative overflow-hidden">
                    <Image
                      ...
                      width={800}
                      height={600}
                      className="object-cover rounded-lg transition-transform duration-500 ease-in-out hover:scale-105 items-center justify-center mx-auto h-auto w-auto"
                    />
                  </Card>
                </CarouselItem>
              ))}
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="bg-zinc-700 p-3 rounded-lg flex items-start">
            ...
            <span className="text-blue-400 font-bold ml-2">crystopia.net</span>
          </div>
